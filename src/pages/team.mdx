...
export const description = "As TechHut Media grows I am looking for individuals who can use their talent and experiences to help spread the love of technology. As of now TechHut is..."

export const date = ""
export const authors = ["Brandon Hopkins", "Cameron Knauff", "Niccolo Venerandi", "Scott Yeager"]
