...
export const description = "Near the end of 2020, Red Hat decided to kill CentOS as we know it—kind of. We'll get that a bit later. But for now, let's examine Red Hat Enterprise Linux and all of the clones and forks that we have available."
