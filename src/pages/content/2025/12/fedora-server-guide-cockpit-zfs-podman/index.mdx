...
export const description = "There's nothing wrong with using Proxmox or TrueNAS for your home server. They're excellent platforms that simplify a lot of complexity. But in this guide,..."
