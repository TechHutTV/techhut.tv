export const title = "Create an AWESOME Home Server/NAS with Proxmox"
export const description = "Yes, Proxmox has a great operating system that can run your NAS and host many other services. I’ve decided to do a complete walkthrough of building my new..."

export const date = "2025-02-03"
export const authors = ["Brandon Hopkins"]
export const categories = ["Guides"]
export const tags = ["Guides", "Proxmox", "Homelab"]
