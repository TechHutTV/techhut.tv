...
export const description = "It's been a couple of years since we dropped a video/article on RHEL clones. However, a ton has changed since we wrote that video/article, and it has aged..."
