...
export const description = "Upgrading or pulling back the kernel on Arch is a common headache—especially when the latest release drops a bug or the hardware suddenly misbehaves."
