export const title = "Self-Host with Immich!"
...
1. **Remote Access Setup (Recommended)**:
   - **[NetBird](https://github.com/TechHutTV/homelab/tree/main/netbird) (Recommended)**: A zero-trust networking solution using WireGuard. NetBird lets you securely access Immich from anywhere without exposing ports on your home network. Follow our [NetBird setup guide](https://github.com/TechHutTV/homelab/tree/main/netbird) to get started.
