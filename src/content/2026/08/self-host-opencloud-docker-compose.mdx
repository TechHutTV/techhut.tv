...
Do note that indexing happens as files get uploaded or changed. Anything already sitting in your storage from before you enabled Tika won't have its contents indexed until you touch it again, so an old document not turning up doesn't mean anything is broken.
