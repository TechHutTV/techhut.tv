...
Add a DNS record for `euro-office.example.com`, which your wildcard already covers. Then append both `weboffice/euro-office.yml` and `external-proxy/euro-office-exposed.yml` to your `COMPOSE_FILE`, and set the domain:
