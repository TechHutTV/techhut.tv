...
This is a configuration pointer rather than a complete client walkthrough; the OpenCloud compose README has the current client URLs and integration details.
...
This is also an optional configuration pointer. Verify the current memory and scanning settings in the compose README before enabling it on a production server.
