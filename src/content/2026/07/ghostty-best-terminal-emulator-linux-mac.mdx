...
export const description = "Ghostty explained from a practical Linux perspective, including installation, my current configuration, modern terminal features, and a Superfile image-preview demonstration."
...
export const cover = "/docs-static/img/2026/07/ghostty-best-terminal-emulator-linux-mac/cover.jpg"
