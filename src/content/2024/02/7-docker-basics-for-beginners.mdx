...
export const description = "If you've been following recent videos on TechHut, you probably know we're big Docker fans. Whether it's media servers, analytic tools, web services, or..."
...
We will use the "convenience script" for one of the easiest ways to install it on your system. Once that's done, any future updates will also be available through `apt`. Here are the commands to install using the script:
