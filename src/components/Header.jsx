      ...
      <div className="flex items-center gap-3 xl:gap-2 flex-shrink-0">
        ...
        <div className="hidden min-[416px]:contents">
          <a
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 font-mono text-2xs font-medium uppercase tracking-wider text-white bg-[#FF0000] hover:bg-[#CC0000] rounded-sm transition-all duration-micro"
          >
