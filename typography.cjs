module.exports = ({ theme }) => ({
  DEFAULT: {
    css: {
      ...
      '--tw-prose-links-underline': theme('colors.primary.800 / 0.3'),
      ...
      '--tw-prose-invert-body': theme('colors.ink.dim'),
      '--tw-prose-invert-headings': theme('colors.ink.DEFAULT'),
      ...
      '--tw-prose-invert-bold': theme('colors.ink.DEFAULT'),
      ...
      '--tw-prose-invert-code': theme('colors.ink.DEFAULT'),
      '--tw-prose-invert-code-bg': theme('colors.zinc.700 / 0.15'),
      '--tw-prose-invert-code-ring': theme('colors.white / 0.1'),
      '--tw-prose-invert-pre-code': theme('colors.ink.dim'),
      '--tw-prose-invert-pre-bg': theme('colors.dark.lighter'),
      ...
      // Headings — Outfit is the display voice (700/800 only)
      h1: {
